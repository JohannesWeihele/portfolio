        ...
        <div>
            ...
            <div className={"project_wrapper"}>
                <AnimationOnScroll delay={-1000} offset={100} animateIn={"animate__fadeInRightBig"} animateOut={"animate__fadeOutLeftBig"} animateOnce={true}>
                    ...
                    <ExpandingButton>
                        <div>
                            <ExpandingList name={"Die Einleitung"} open={true}>
                                <div>
                            ...
                            <ExpandingList name={"Die Entwicklungsumgebung"}>
                                <p className={"max_width_text"}>
                                    ...
                                    </a>, welcher mir ermöglichen sollte, neben der Darstellung und Entwicklung gewöhnlicher 2D-Elemente, auch 3D-Objekte in das Projekt zu laden, um so beispielsweise 3D-Modelle von Fahrzeugen in die UI einzubinden
                                </p>
                            </ExpandingList>
                            <ExpandingList name={"Die Umsetzung"}>
                                <p className={"max_width_text"}>
